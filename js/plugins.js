        ...
        (e.Defaults = {
            ...
            (e.prototype.getPosition = function (b) {
                var c,
                    ...
                    e = this._core.settings;
                return (
                    "page" == e.slideBy ? ((c = a.inArray(this.current(), this._pages)), (d = this._pages.length), b ? ++c : --c, (c = this._pages[((c % d) + d) % d].start)) : ((c = this._core.relative(this._core.current())), (d = this._core.items().length), b ? (c += e.slideBy) : (c -= e.slideBy)),
                    c
                );
            }),
...
var pJS = function (e, a) {
    ...
    a && Object.deepExtend(i, a),
        ...
        (i.fn.particle = function (e, a, t) {
            ...
            i.particles.move.straight ? ((this.vx = n.x), (this.vy = n.y), i.particles.move.random && ((this.vx = this.vx * Math.random()), (this.vy = this.vy * Math.random()))) : ((this.vx = n.x + Math.random() - 0.5), (this.vy = n.y + Math.random() - 0.5)),
                (this.vx_i = this.vx),
                (this.vy_i = this.vy);
            ...
            for (var e = 0; e < i.particles.array.length; e++) {
                ...
                if (
                    (i.particles.opacity.anim.enable &&
                        (1 == a.opacity_status ? (a.opacity >= i.particles.opacity.value && (a.opacity_status = !1), (a.opacity += a.vo)) : (a.opacity <= i.particles.opacity.anim.opacity_min && (a.opacity_status = !0), (a.opacity -= a.vo)), a.opacity < 0 && (a.opacity = 0)),
...
!(function (e, t) {
    ...
    function i(e, t, r) {
        ...
        var n = {};
        if (((n.id = s.createProgram()), s.attachShader(n.id, i(s.VERTEX_SHADER, e)), s.attachShader(n.id, i(s.FRAGMENT_SHADER, t)), s.linkProgram(n.id), !s.getProgramParameter(n.id, s.LINK_STATUS))) throw new Error("link error: " + s.getProgramInfoLog(n.id));
        (n.uniforms = {}), (n.locations = {}), s.useProgram(n.id), s.enableVertexAttribArray(0);
        for (var o, a, u = /uniform (\w+) (\w+)/g, h = e + t; null != (o = u.exec(h)); ) (a = o[2]), (n.locations[a] = s.getUniformLocation(n.id, a));
        return n;
    }
    function n(e, t) {
    ...
    var s,
        ...
        h = (function () {
            ...
            for (var a = null, u = 0; u < i.length; u++)
                if ((s.texImage2D(s.TEXTURE_2D, 0, s.RGBA, 32, 32, 0, s.RGBA, i[u].type, null), s.framebufferTexture2D(s.FRAMEBUFFER, s.COLOR_ATTACHMENT0, s.TEXTURE_2D, n, 0), s.checkFramebufferStatus(s.FRAMEBUFFER) === s.FRAMEBUFFER_COMPLETE)) {
                    a = i[u];
                    break;
                }
            return a;
    ...
    var d = function (t, r) {
        ...
        for (var a = 0; a < 2; a++) {
            ...
            s.bindFramebuffer(s.FRAMEBUFFER, c),
                ...
                s.texParameteri(s.TEXTURE_2D, s.TEXTURE_WRAP_S, s.CLAMP_TO_EDGE),
                s.texParameteri(s.TEXTURE_2D, s.TEXTURE_WRAP_T, s.CLAMP_TO_EDGE),
                s.texImage2D(s.TEXTURE_2D, 0, s.RGBA, this.resolution, this.resolution, 0, s.RGBA, h.type, null),
                s.framebufferTexture2D(s.FRAMEBUFFER, s.COLOR_ATTACHMENT0, s.TEXTURE_2D, u, 0),
    ...
    (d.DEFAULTS = { imageUrl: null, resolution: 256, dropRadius: 20, perturbance: 0.03, interactive: !0, crossOrigin: "" }),
        (d.prototype = {
            ...
            update: function () {
                s.viewport(0, 0, this.resolution, this.resolution), s.bindFramebuffer(s.FRAMEBUFFER, this.framebuffers[this.bufferWriteIndex]), n(this.textures[this.bufferReadIndex]), s.useProgram(this.updateProgram.id), this.drawQuad(), this.swapBufferIndices();
            },
            ...
            computeTextureBoundaries: function () {
                ...
                if (("fixed" == n ? (((e = { left: window.pageXOffset, top: window.pageYOffset }).width = u.width()), (e.height = u.height())) : (((e = this.$el.offset()).width = this.$el.innerWidth()), (e.height = this.$el.innerHeight())), "cover" == i))
    ...
    (e.fn.ripples = function (t) {
        ...
        return this.each(function () {
            ...
            (n || "string" != typeof t) && (n ? "string" == typeof t && d.prototype[t].apply(n, r) : i.data("ripples", (n = new d(this, o))));
        });
    }),
...
+(function (a) {
    ...
    (d.DEFAULTS = { delay: 500, html: !1, disable: !0, custom: {}, errors: { match: "Does not match", minlength: "Not long enough" }, feedback: { success: "glyphicon-ok", error: "glyphicon-warning-sign" } }),
        (d.VALIDATORS = {
            native: function (a) {
                var b = a[0];
